...
(** Nethsm-crypto implements public key cryptography with named elliptic
...
module type Parameters_twisted =
  sig
    include Parameters
    val z : string
  end

module type Foreign_field =
  sig
...
module Make_field_element :
  functor (P : Parameters) (F : Foreign_mont) -> Field_element

module Make_field_element_usol :
  functor (P : Parameters) (F : Foreign_field) -> Field_element
...
module Make_point_twisted (P : Parameters_twisted) (F : Foreign_point) (Fe : Field_element)
  : Point
...
module Make_scalar_element :
  functor (P : Parameters) (F : Foreign_n) ->
    sig
...
module Make_dsa :
  functor (Param : Parameters) (F : Scalar_element) (P : Point) (S :
    Scalar) (H : Digestif.S) ->
    sig
      type priv = scalar
      val byte_length : int
