#include "common.h"
#include "p384_kiila.h"

CAMLprim value mc_p384_sub(value out, value a, value b)
{
	CAMLparam3(out, a, b);
	fiat_secp384r1_sub((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp384r1_add((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp384r1_mul((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_from_bytes((limb_t*)Bytes_val(out), _st_uint8(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_to_bytes(Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_square((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_from_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_to_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
CAMLprim value mc_p384_nz(value x)
{
	CAMLparam1(x);
	limb_t ret;
	fiat_secp384r1_nonzero(&ret, (const limb_t*)String_val(x));
...
{
	CAMLparam1(x);
    fiat_secp384r1_set_one((limb_t*)Bytes_val(x));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp384r1_inv((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
CAMLprim value mc_p384_scalar_mult(value out, value s, value p)
{
    CAMLparam3(out, s, p);
...
CAMLprim value mc_p384_scalar_mult_add(value out, value a, value b, value p)
{
